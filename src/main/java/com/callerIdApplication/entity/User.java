...
public class User {
    ...
    // Getters y Setters para spammer
    public boolean isSpammer() { return spammer; }
    public void setSpammer(boolean spammer) { this.spammer = spammer; }

    public String getUuid() {
        if (this.uuid == null || this.uuid.isEmpty()) return "USR" + (this.phoneNumber != null ? this.phoneNumber : "0000");
        return uuid;
    }
